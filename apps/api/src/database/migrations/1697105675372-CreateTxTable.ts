...
export class CreateTxTable1697105675372 implements MigrationInterface {
    name = 'CreateTxTable1697105675372'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "drop" ADD "transaction_id" integer NOT NULL`);
