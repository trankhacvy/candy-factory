...
import { BaseResponse } from "@/app/api/type"
...
export const nftFormSchema = z.object({
  ...
  image: z.string({ required_error: "This field is required." }).trim().min(1, "This field is required."),
  name: z
...
export function CampaignForm() {
  ...
  async function onSubmit(values: z.infer<typeof nftFormSchema>) {
    try {
      ...
      const response = await fetcher<BaseResponse<boolean>>("/api/create-nft-metadata", {
        method: "POST",
        headers: {
